...
def main():
    ...
    print(f"  Attention heads:    {config.num_attention_heads} Q / {config.num_key_value_heads} KV (GQA)")
    print(f"  MoE Experts:        {config.num_experts} total, top-{config.num_experts_per_token} active")
