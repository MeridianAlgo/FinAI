...
def run_mini_training(run_number, checkpoint_path="./test_checkpoint"):
    ...
    if checkpoint_exists and weights_exist:
        ...
        print(f"⚠ No checkpoint found - initializing fresh model")
    ...
    for i, result in enumerate(results):
        ...
        if i > 0:
            ...
            if diff < 0.1:  # Should be very close
                ...
                print(f"  ✗ CASCADING FAILED! Previous final: {prev_final:.4f}, Current initial: {curr_initial:.4f} (diff: {diff:.4f})")
        print()
